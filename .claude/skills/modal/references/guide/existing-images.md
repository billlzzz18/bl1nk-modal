...
To pull container images from private Docker Hub repositories, create an access token
with "Read-Only" permissions and use it along with your Docker Hub username
to create a Modal [Secret](/docs/guide/secrets).
