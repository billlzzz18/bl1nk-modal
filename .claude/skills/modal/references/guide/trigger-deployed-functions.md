...
* An existing Python web server (eg. Django, Flask) wants to invoke Modal
  Functions.
* You have split your product or system into multiple Modal Apps that
...
[`FunctionCall`](/docs/sdk/py/latest/modal.FunctionCall) as a
...
[`FunctionCall`](/docs/sdk/py/latest/modal.FunctionCall)
...
Apps via [Web Functions](/docs/guide/webhooks). Note that
