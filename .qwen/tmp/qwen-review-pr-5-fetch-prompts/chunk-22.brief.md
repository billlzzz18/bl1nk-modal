You are reviewing chunk 22 of 23 of a code diff.

Your territory: lines 6832-7185 of the diff (354 lines, 14005 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- modal-apps/bl1nk-app/modal_app.py (new-side lines 1-308)
...
Then, on its own final line: `Covered: chunk 22 lines 6832-7185`