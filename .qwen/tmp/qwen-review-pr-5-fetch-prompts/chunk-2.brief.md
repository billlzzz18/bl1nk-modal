You are reviewing chunk 2 of 23 of a code diff.

Your territory: lines 301-478 of the diff (178 lines, 11199 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- .qwen/skills/auto-skill-bump-base-image-version/SKILL.md (new-side lines 1-71)
- .qwen/skills/auto-skill-deploy-bl1nk-app/SKILL.md (new-side lines 1-95)
...
Then, on its own final line: `Covered: chunk 2 lines 301-478`