You are reviewing chunk 7 of 23 of a code diff.

Your territory: lines 2131-2517 of the diff (387 lines, 15097 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- modal-apps/bl1nk-app/environments/docker.py (new-side lines 1-381)
...
Then, on its own final line: `Covered: chunk 7 lines 2131-2517`