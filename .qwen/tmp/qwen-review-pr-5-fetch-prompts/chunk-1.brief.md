You are reviewing chunk 1 of 23 of a code diff.

Your territory: lines 1-300 of the diff (300 lines, 19117 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- .claude/.claude-plugin/plugin.json (new-side lines 0-0)
- .claude/.claude-plugin/plugin.json:Zone.Identifier (new-side lines 0-0)
- .claude/.codex-plugin/plugin.json (new-side lines 0-0)
- .claude/.codex-plugin/plugin.json:Zone.Identifier (new-side lines 0-0)
- .claude/README.md (new-side lines 0-0)
- .claude/agents/conductor-validator.md (new-side lines 2-8)
- .claude/commands/implement.md (new-side lines 0-0)
- .claude/commands/manage.md (new-side lines 0-0)
- .claude/commands/new-track.md (new-side lines 0-0)
- .claude/commands/revert.md (new-side lines 0-0)
- .claude/commands/setup.md (new-side lines 0-0)
- .claude/commands/status.md (new-side lines 0-0)
- .claude/skills/context-driven-development/SKILL.md (new-side lines 1-6)
- .claude/skills/context-driven-development/references/artifact-templates.md (new-side lines 0-0)
- .claude/skills/context-driven-development/references/artifact-templates.md:Zone.Identifier (new-side lines 0-0)
- .claude/skills/context-driven-development/references/details.md (new-side lines 0-0)
- .claude/skills/context-driven-development/references/details.md:Zone.Identifier (new-side lines 0-0)
- .claude/skills/track-management/SKILL.md (new-side lines 0-0)
- .claude/skills/track-management/SKILL.md:Zone.Identifier (new-side lines 0-0)
- .claude/skills/track-management/references/details.md (new-side lines 0-0)
- .claude/skills/track-management/references/details.md:Zone.Identifier (new-side lines 0-0)
- .claude/skills/workflow-patterns/SKILL.md (new-side lines 0-0)
- .claude/skills/workflow-patterns/SKILL.md:Zone.Identifier (new-side lines 0-0)
- .claude/skills/workflow-patterns/references/details.md (new-side lines 0-0)
- .claude/skills/workflow-patterns/references/details.md:Zone.Identifier (new-side lines 0-0)
- .claude/templates/code_styleguides/csharp.md (new-side lines 0-0)
- .claude/templates/code_styleguides/dart.md (new-side lines 0-0)
- .claude/templates/code_styleguides/general.md (new-side lines 0-0)
- .claude/templates/code_styleguides/go.md (new-side lines 0-0)
- .claude/templates/code_styleguides/html-css.md (new-side lines 0-0)
- .claude/templates/code_styleguides/javascript.md (new-side lines 0-0)
- .claude/templates/code_styleguides/python.md (new-side lines 0-0)
- .claude/templates/code_styleguides/typescript.md (new-side lines 0-0)
- .claude/templates/index.md (new-side lines 0-0)
- .claude/templates/product-guidelines.md (new-side lines 0-0)
- .claude/templates/product.md (new-side lines 0-0)
- .claude/templates/tech-stack.md (new-side lines 0-0)
- .claude/templates/track-metadata.json (new-side lines 0-0)
- .claude/templates/track-plan.md (new-side lines 0-0)
- .claude/templates/track-spec.md (new-side lines 0-0)
- .claude/templates/tracks.md (new-side lines 0-0)
- .claude/templates/workflow.md (new-side lines 0-0)
- .qwen/skills/auto-skill-build-rust-engine-on-modal/SKILL.md (new-side lines 1-105)
...
Then, on its own final line: `Covered: chunk 1 lines 1-300`