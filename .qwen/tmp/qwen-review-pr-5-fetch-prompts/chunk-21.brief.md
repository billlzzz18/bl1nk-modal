You are reviewing chunk 21 of 23 of a code diff.

Your territory: lines 6451-6831 of the diff (381 lines, 15369 characters). The surrounding chunks belong to other agents — do not review them.

It covers these source files:
- modal-apps/bl1nk-app/environments/ssh.py (new-side lines 1-375)
...
Then, on its own final line: `Covered: chunk 21 lines 6451-6831`